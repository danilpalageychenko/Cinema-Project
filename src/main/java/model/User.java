...
public class User extends Entity{
    ...
    public User(String login,String password,String name, String surName, String bday,String role){
        setLogin(login);
    ...
    {
        this.tickets = new Gson().fromJson(tickets,new TypeToken<ArrayList<Integer>>() {}.getType());
    }
